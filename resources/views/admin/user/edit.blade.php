                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::select('role', ['tutor' => 'Tutor', 'user' => 'User' , 'admin' => 'Admin'] ,$role->name , ['class' => 'form-control select2', 'style'=> 'margin-bottom:10px;']) }}
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <br>
                                                       <img src="{{$user->profile->image }}" class="img-fluid img-thumbnail" alt="Responsive image" height="300px" width="300px">
                                                    </div>
                                                </div>
                                            </div>
