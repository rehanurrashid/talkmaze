                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            @if(isset($user))
                                                {{ Form::model($user,['method'=>'post','route' => ['users.store',$user->id], 'enctype' =>'multipart/form-data']) }}
                                            @else
                                                {{ Form::open(['route' => 'users.index', 'enctype' =>'multipart/form-data']) }}
                                            @endif
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('name','Name') }}<span style="color:red;">*</span>
                                                        {{ Form::text('name',old('name'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter User Name' ,'id' => 'name')) }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('address',old('address'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter  Address')) }}
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('city',old('city'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter City Name')) }}
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('country',old('country'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Country Name')) }}
