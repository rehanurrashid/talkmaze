                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div>
                                    <a class="btn btn-dark w-25" href="{{ route('applicants.create') }}">Add New</a>
                                </div>
                            </div>
                        </div>
                        <br>
                                            ...
                                            $(function() {
                                                $('#rtable').DataTable({
                                                    ...
                                                    columns: [
                                                        ...
                                                        { data: 'debate', name: 'debate' },
                                                        { data: 'experience', name: 'experience' },
                                                        { data: 'education_level', name: 'education_level' },
                                                        { data: 'why_to_join', name: 'why_to_join' },
                                                        { data: 'resume', name: 'resume' },
                                                        { data: 'education_level', name: 'education_level' },
                                                        { data: 'how_here_about_us', name: 'how_here_about_us' },
