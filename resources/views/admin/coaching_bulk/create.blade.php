...
@section('title', 'Add Coaching Bulk')
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-header header-elements-inline">
                                            <h6 class="card-title">{{(isset($coaching_bulk)) ? 'Update' : 'Add'}} Coaching Bulk </h6>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('phone',old('phone'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Phone Number')) }}
