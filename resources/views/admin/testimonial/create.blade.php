                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-header header-elements-inline">
                                            <h6 class="card-title">{{(isset($testimonial)) ? 'Update' : 'Add'}} Testimonial </h6>
                                        ...
                                        <div class="card-body">
                                            @if(isset($testimonial))
                                                {{ Form::model($testimonial,['method'=>'post','route' => ['testimonials.update',$testimonial->id],'enctype' => 'multipart/form-data']) }}
                                            @else
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('name',old('name'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Client Name')) }}
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('photo','Client Image') }}<span style="color:red;">*</span>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('feedback','Feedback') }}<span style="color:red;">*</span>
                                                        {{ Form::textarea('feedback',old('feedback'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Feedback')) }}
                                                        {!! $errors->first('feedback', '<label id="feedback-error" class="error" for="feedback">:message</label>') !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-end align-items-center">
                                                <button type="submit" name="submit" class="btn bg-blue ml-3">{{(isset($testimonial)) ? 'Update' : 'Save'}} </button>
                                            </div>
