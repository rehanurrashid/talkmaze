                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            @if(isset($testimonial))
                                                {{ Form::model($testimonial,['method'=>'put','route' => ['testimonials.update',$testimonial->id],'enctype' => 'multipart/form-data']) }}
                                            @else
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <br>
                                                       <img src="{{ $testimonial->image }}" class="img-fluid img-thumbnail" alt="Responsive image" height="300px" width="300px">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
