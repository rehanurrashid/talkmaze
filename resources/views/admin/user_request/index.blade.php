                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div>
                                    <a class="btn btn-dark w-25" href="{{ route('user_requests.create') }}">Add New</a>
                                </div>
                            </div>
                        </div>
                        <br>
                                    ...
                                    <div class="card">
                                        ...
                                        <table class="table" id="rtable">
                                            ...
                                            <tr>
                                                ...
                                                <th>user_id</th>
                                                <th>tutor_id</th>
                                                <th>why_would_you_like_to_be_matched_with_a_coach</th>
                                                <th>experience_of_public_speaking</th>
                                                <th>do_you_have_access_to_a_webcam_and_mic</th>
                                                <th>Actions</th>
                                            </tr>
                                            </thead>
                                        </table>
                                        ...
                                        <script>
                                            $(function() {
                                                $('#rtable').DataTable({
                                                    ...
                                                    autoWidth: false,
                                                    responsive: true,
                                                    ajax: '{!! route('user_requests.index') !!}',
                                                    columns: [
                                                        { data: 'id', name: 'id' },
                                                        { data: 'user_id', name: 'user_id' },
                                                        { data: 'tutor_id', name: 'tutor_id' },
                                                        { data: 'why_would_you_like_to_be_matched_with_a_coach', name: 'why_would_you_like_to_be_matched_with_a_coach' },
                                                        { data: 'experience_of_public_speaking', name: 'experience_of_public_speaking' },
                                                        { data: 'do_you_have_access_to_a_webcam_and_mic', name: 'do_you_have_access_to_a_webcam_and_mic' },
