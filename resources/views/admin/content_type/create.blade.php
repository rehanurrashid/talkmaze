...
@section('title', 'Add Content Type')
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-header header-elements-inline">
                                            <h6 class="card-title">{{(isset($content_type)) ? 'Update' : 'Add'}} Content Type </h6>
                                        ...
                                        <div class="card-body">
                                            @if(isset($content_type))
                                                {{ Form::model($content_type,['method'=>'put','route' => ['content_types.update',$content_type->id]]) }}
                                            @else
                                                {{ Form::open(['route' => 'content_types.store']) }}
                                            @endif
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('title','Content Type') }}<span style="color:red;">*</span>
                                                        {{ Form::text('title',old('title'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Content Type')) }}
