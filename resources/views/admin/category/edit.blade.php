                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            @if(isset($category))
                                                {{ Form::model($category,['method'=>'put','route' => ['categories.update',$category->id],'enctype' => 'multipart/form-data']) }}
                                            @else
                                                {{ Form::open(['route' => 'categories.index','enctype' => 'multipart/form-data']) }} 
                                            @endif
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('name','Category Name') }}<span style="color:red;">*</span>
                                                        {{ Form::text('name',old('name'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Category Name')) }}
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                       ...
                                                       @php $categories[''] = 'Please Select Parent Category'; @endphp

                                                        {{ Form::select('parent_id', $categories ,'video', ['class' => 'form-control select2', 'style'=> 'margin-bottom:10px;']) }}
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <br>
                                                       <img src="{{asset('storage/storage/'.$category->image) }} " class="img-fluid img-thumbnail" alt="Responsive image" height="300px" width="300px">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-end align-items-center">
                                                <button type="submit" name="submit" class="btn bg-blue ml-3">{{(isset($category)) ? 'Update' : 'Save'}} </button>
                                            </div>
