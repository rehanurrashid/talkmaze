                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            @if(isset($social_link))
                                                {{ Form::model($social_link,['method'=>'put','route' => ['social_links.update',$social_link->id],'enctype' => 'multipart/form-data']) }}
                                            @else
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <br>
                                                       <img src="{{asset('storage/storage/'.$social_link->image) }} " class="img-fluid img-thumbnail" alt="Responsive image" height="300px" width="300px">
                                                    </div>
                                                </div>
                                            </div>
