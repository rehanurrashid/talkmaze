                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-header header-elements-inline">
                                            <h6 class="card-title">{{(isset($social_link)) ? 'Update' : 'Add'}} Social Link </h6>
                                        ...
                                        <div class="card-body">
                                            @if(isset($social_link))
                                                {{ Form::model($social_link,['method'=>'post','route' => ['social_links.update',$social_link->id],'enctype' => 'multipart/form-data']) }}
                                            @else
                                                {{ Form::open(['route' => 'social_links.store' ,'enctype' => 'multipart/form-data']) }}
                                            @endif
                                            <div class="row">
                                                <div class="col">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('link','Social Link') }}<span style="color:red;">*</span>
                                                        {{ Form::text('link',old('link'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Social Link')) }}
                                                        {!! $errors->first('link', '<label id="link-error" class="error" for="link">:message</label>') !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('photo','Social Image') }}<span style="color:red;">*</span>
                                            ...
                                            <div class="d-flex justify-content-end align-items-center">
                                                <button type="submit" name="submit" class="btn bg-blue ml-3">{{(isset($social_link)) ? 'Update' : 'Save'}} </button>
                                            </div>
