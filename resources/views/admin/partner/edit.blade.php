                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-header header-elements-inline">
                                            <h6 class="card-title">{{(isset($partner)) ? 'Update' : 'Add'}} Partner </h6>
                                        ...
                                        <div class="card-body">
                                            @if(isset($partner))
                                                {{ Form::model($partner,['method'=>'put','route' => ['partners.update',$partner->id],'enctype' => 'multipart/form-data']) }}
                                            @else
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('name','Partner Name') }}<span style="color:red;">*</span>
                                                        {{ Form::text('name',old('name'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Partner Name')) }}
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('photo','Partner Image') }}<span style="color:red;">*</span>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <br>
                                                       <img src="{{asset('storage/storage/'.$partner->image) }} " class="img-fluid img-thumbnail" alt="Responsive image" height="300px" width="300px">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-end align-items-center">
                                                <button type="submit" name="submit" class="btn bg-blue ml-3">{{(isset($partner)) ? 'Update' : 'Save'}} </button>
                                            </div>
